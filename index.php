        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <h4> <img src="assets/images/tufaayologo.png" style="width: 60px;height:60px;" alt=""> Tufaayo<span> Foundation</span></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/refined.png" class=" img-fluid rounded" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  ...
                  <div class="right-text">
                    <h4>We care for young pregnant mothers</h4>
              ...
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
                  ...
                  <div class="right-text">
                    <h4>Provide scholaristic materials.</h4>
                    <p>Lorem ipsum dolor sit amet, ctetur aoi adipiscing eliter</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                  ...
                  <div class="right-text">
                    <h4>Sensitize about sanitation</h4>
                    <p>Lorem ipsum dolor sit amet, ctetur aoi adipiscing eliter</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="1.1s">
                  ...
                  <div class="right-text">
                    <h4>Impart life saving skills</h4>
                    <p>Lorem ipsum dolor sit amet, ctetur aoi adipiscing eliter</p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="section-heading">
            <h2>What we <em>Cherish</em>  in our &amp; <span>organisation</span> </h2>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="hidden-content">
                <h4>Support to pregnant mothers</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
              <div class="hidden-content">
                <h4>Supporting schools without enough scholaristic materials</h4>
                <p>Lorem ipsum dolor sit ameti ctetur aoi adipiscing eto.</p>
              </div>
              <div class="showed-content">
                <img src="assets/images/portfolio-image.png" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
              <div class="hidden-content">
                <h4>Networking with both government and non government organisations</h4>
                <p>Lorem ipsum dolor sit ameti ctetur aoi adipiscing eto.</p>
              </div>
              <div class="showed-content">
                <img src="assets/images/portfolio-image.png" alt="">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="left-image">
            <a href="#"><img src="assets/images/gp.jpeg" alt="Workspace Desktop"></a>
            <div class="info">
            ...
            <ul>
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="assets/images/hosp.jpeg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
                ...
                <div class="right-image">
                  <a href="#"><img src="assets/images/4.jpeg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
                ...
                <div class="right-image">
                  <a href="#"><img src="assets/images/sch.jpeg" alt=""></a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="col-lg-6 align-self-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <div class="section-heading">
            ...
            <div class="phone-info">
              <h4>Call Us: <span><i class="fa fa-phone"></i> <a href="#">+256 726 49 796 / +256 758 115 817</a></span></h4>
            </div>
          </div>
        </div>
